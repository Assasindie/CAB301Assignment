...
namespace CAB301Assignment
{
    class Program
    {
        //create the instances of the collections
        ...
        static void Main(string[] args)
        {
           //initialise lists with some movies
            Movie Movie1 = new Movie { Classification = Classification.General, Genre = Genre.Adventure, Copies = 0, Director = "Jeff", Starring = new string[] { "People", "Brad", "Someone" },
            ...
            Movie Movie5 = new Movie { Classification = Classification.General, Genre = Genre.Drama, Copies = 10, Director = "Tony", Starring = new string[] { "Lachlan", "Mr Bones" },
            ...
            Movie Movie7 = new Movie { Classification = Classification.General, Genre = Genre.Other, Copies = 4, Director = "Steve", Starring = new string[] { "Brad", "Overpaid Person" },
            ...
            Movie Movie9 = new Movie { Classification = Classification.General, Genre = Genre.Thriller, Copies = 15, Director = "Richard", Starring = new string[] { "Brad", "Mr Bones" },
                Length = 90, ReleaseDate = "11/11/11", TimesBorrowed = 20, Title = "Movie 9" };
            Movie Movie10 = new Movie { Classification = Classification.General, Genre = Genre.Adventure, Copies = 6, Director = "Lachlan", Starring = new string[] { "Jeff", "Mr Bones" },
            ...
            Movie Movie12 = new Movie { Classification = Classification.General, Genre = Genre.Other, Copies = 9, Director = "Josh", Starring = new string[] { "Josh" },
